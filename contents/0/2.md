...
> IDlE调整高亮主题样式方法： 在菜单栏Options -&gt; Configure IDLE， 在出现的窗口中，点击Highlights面板， 点击IDlE Classic，选择IDLE Dark, ![](../../.gitbook/assets/2_5.png) 就可以切换成黑暗主题，该主题效果 ![](../../.gitbook/assets/2_6.png) 除此之外，在左边还可以自定义高亮主题
...
1. 输入`python demo2.py`并回车，就运行了`demo2.py`这个文件。
